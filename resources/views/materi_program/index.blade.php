...
@section('title', 'Materi Program')
@section('content')
    <div class="page-heading">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>Materi Program</h3>
            </div>
            <div class="col-12 col-md-6 order-md-2 order-first">
                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('owner.dashboard') }}">Dashboard</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Materi Program</li>
                    </ol>
                </nav>
            </div>
        </div>
    ...
    <div class="page-content">
        ...
        <div class="card radius-10">
            <div class="card-header d-flex align-items-center justify-content-between">
                <h5 class="card-title mb-0">Daftar Materi Program</h5>
                <a href="{{ route('materi_program.create') }}" class="btn btn-primary" id="add-product-btn">
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '.delete-btn', function() {
                ...
                const url = "{{ route('materi_program.destroy', ':id') }}".replace(':id', id);
