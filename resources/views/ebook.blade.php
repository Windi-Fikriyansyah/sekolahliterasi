@extends('layouts.app')
@section('title', 'Program Terbaru - SekolahLiterasi')
@section('content')
    ...
    <section class="relative bg-gradient-to-r from-secondary to-primary py-20">
        <div class="container mx-auto px-4">
            <div class="text-center text-white animate-fade-in-up">
                <h1 class="text-4xl md:text-6xl font-bold mb-6">Kumpulan Ebook</h1>
                <p class="text-xl md:text-2xl mb-8 opacity-90">Temukan E-book terbaru untuk meningkatkan skill dan karir
                    Anda
                </p>
            </div>
        </div>
