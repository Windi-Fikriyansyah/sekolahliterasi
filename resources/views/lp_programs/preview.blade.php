...
<body>
    ...
    <script type="text/javascript">
        ...
        // Fungsi untuk mendapatkan HTML dan CSS terpisah
        function getSeparatedHtmlAndCss() {
            return {
                html: editor.getHtml(),
                css: editor.getCss()
            };
        ...
        // Event listener untuk menyimpan HTML dan CSS terpisah
        editor.on('storage:store', (data) => {
            // Tambahkan HTML dan CSS ke data yang akan disimpan
            const htmlCss = getSeparatedHtmlAndCss();
            data.html = htmlCss.html;
            data.css = htmlCss.css;
        });
    </script>
</body>
