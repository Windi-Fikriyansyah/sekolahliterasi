...
class KategoriBukuController extends Controller
{
        ...
        try {
            ...
            return DataTables::of($kategori)
                ...
                ->addColumn('action', function ($row) {
                    ...
                    $deleteUrl = route('kategori_buku.destroy', $row->id);

                    $buttons = '<div class="btn-group" role="group">';
                    $buttons .= '<a href="' . route('kategori_buku.edit', $row->id) . '" class="btn btn-sm btn-warning me-1" title="Edit"><i class="bi bi-pencil"></i></a>';
    ...
    public function destroy($id)
    {
        try {
            ...
            $deleted = DB::table('kategori_buku')->where('id', $id)->delete();
    ...
    {
        $kategori = DB::table('kategori_buku')->where('id', $id)->first();
        return view('kategori_buku.create', compact('kategori'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            $course = DB::table('kategori_buku')->where('id', $id)->first();
            ...
            DB::table('kategori_buku')->where('id', $id)->update($dataUpdate);
